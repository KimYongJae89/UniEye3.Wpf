...
set FILENAME=UniEye3Wpf_master_%DATE.YEAR%%DATE.MONTH%%DATE.DAY%_%DATE.HOUR%%DATE.MINUTE%%DATE.SECOND%.diff.bundle
echo FinleName : %FILENAME%
echo.
echo.
echo.
git bundle create %FILENAME% master origin/master..master
