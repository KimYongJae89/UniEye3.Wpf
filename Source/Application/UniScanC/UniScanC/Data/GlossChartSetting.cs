...
{
    public class GlossChartSetting : Observable
    {
        #region 필드
        ...
        #region 메서드
        public void CopyFrom(GlossChartSetting chartSetting)
        {
        ...
        public GlossChartSetting Clone()
        {
            var chartSetting = new GlossChartSetting();
    ...
    public class GlossChartSettingJsonConverter : JsonCreationConverter<GlossChartSetting>
    {
        #region 메서드
        ...
        protected override GlossChartSetting Create(Type objectType, JObject jObject)
        {
            return new GlossChartSetting();
        }
        #endregion
    }
}
