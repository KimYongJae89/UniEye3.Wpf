...
{
    public class DefectDetailHorizentalControlViewModel : CustomizeControlViewModel, INotifyModelChanged, INotifySelectedDefectChanged
    {
        #region 생성자
        public DefectDetailHorizentalControlViewModel() : base(typeof(DefectDetailHorizentalControlViewModel))
        {
        ...
        {
            return new DefectDetailHorizentalControlView();
        }
        #endregion
    }
}
