...
{
    public class LabelerControlViewModel : CustomizeControlViewModel
    {
        #region 생성자
        public LabelerControlViewModel() : base(typeof(LabelerControlViewModel))
        {
            ...
            {
                if (port.Name.Contains(LabelMarkerIoPortNameBase))
                {
        ...
        private string LabelMarkerIoPortNameBase { get; set; } = "Vision2Label";
        #endregion
